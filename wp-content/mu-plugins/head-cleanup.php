...
Plugin URI:         
Description:        Robust Head Cleanup to remove WP cruft
Version:            1.0.0
...
if ( ! class_exists( 'cleanup' ) ) :
	...
	class cleanup {
		...
		public function __construct() {
            ...
            // add_action( 'wp_enqueue_scripts', array( $this, 'random_cleanup' ), 20 );
            // add_action( 'wp_enqueue_scripts', array( $this, 'block_editor_cleanup' ), 20 );
 ...
 */
public function block_editor_cleanup() {
 ...
 * Disable Block Editor
 */
public function random_cleanup() {
