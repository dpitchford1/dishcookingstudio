    ...
    <div class="simple-gridx3">
        ...
        if( isset( $args->performers ) && !empty( $args->performers ) ) {?>
            ...
            <div class="ep-alert ep-alert-warning ep-mt-3 ep-fs-6">
                <?php ( isset( $_GET['ep_search'] ) ) ? esc_html_e( 'No performers found related to your search.', 'eventprime-event-calendar-management' ) : esc_html_e( 'Currently, there are no Chefs. Please check back later.', 'eventprime-event-calendar-management' ); ?>
            </div><?php
        }?>
    </div>
</div>