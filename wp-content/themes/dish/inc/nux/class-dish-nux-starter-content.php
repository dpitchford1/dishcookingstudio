<?php
/**
 * Dish NUX Starter Content Class
 *
 * @package  dish
 * @since    2.0.0
 */
...
if ( ! class_exists( 'Dish_NUX_Starter_Content' ) ) :

	/**
	 * The Dish NUX Starter Content class
	 */
	class Dish_NUX_Starter_Content {
		/**
		 * Setup class.
		 *
		 * @since 2.2.0
		...
		public function __construct() {
			...
			if ( ! isset( $_GET['sf_starter_content'] ) || 1 !== absint( $_GET['sf_starter_content'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				add_filter( 'dish_starter_content', '__return_empty_array' );
			}
		}

		/**
		 * Remove default widgets on activation
		 * Set an option so that this is only done the first time the user activates Dish.
		 *
		 * @since 2.2.0
		 * @return void
		 */
		public function remove_default_widgets() {
			if ( false === (bool) get_option( 'dish_cleared_widgets' ) && true === (bool) get_option( 'dish_nux_fresh_site' ) ) {
				update_option( 'sidebars_widgets', array( 'wp_inactive_widgets' => array() ) );
				update_option( 'dish_cleared_widgets', true );
			}
		}
		...
		public function starter_content() {
			$starter_content = array(
				'posts'       => array(
					'home'    => array(
						'post_title' => esc_attr__( 'Homepage', 'dish' ),
						'template'   => 'template-fullwidth.php',
					),
					'about'   => array(
						'post_type'    => 'page',
						'post_title'   => __( 'About', 'dish' ),
						'post_content' => __( 'You might be an artist who would like to introduce yourself and your work here or maybe you&rsquo;re a business with a mission to describe.', 'dish' ),
					),
					'contact' => array(
						'post_type'    => 'page',
						'post_title'   => __( 'Contact', 'dish' ),
						'post_content' => __( 'This is a page with some basic contact information, such as an address and phone number. You might also try a plugin to add a contact form.', 'dish' ),
					),
					'blog',
				),
				'attachments' => array(
			...
			$woocommerce_pages        = Dish_NUX_Admin::get_woocommerce_pages();
			 ...
			 */
			add_theme_support( 'starter-content', apply_filters( 'dish_starter_content', $starter_content ) );
		}
		...
		public function filter_start_content( $content, $config ) {
			...
			if ( true !== (bool) get_option( 'dish_nux_fresh_site' ) ) {
				unset( $content['posts']['about'] );
				unset( $content['posts']['contact'] );
				unset( $content['nav_menus'] );
				unset( $content['widgets'] );
		...
		public function add_product_tax() {
			...
			add_filter( 'dish_product_categories_shortcode_args', array( $this, 'filter_sf_categories' ) );
		}
		...
		/**
		 * Filter Dish Product Categories shortcode.
		 *
		 * @since 2.2.0
		...
		private function starter_content_products() {
			$accessories_name        = esc_attr__( 'Accessories', 'dish' );
			$accessories_description = esc_attr__( 'A short category description', 'dish' );

			$hoodies_name        = esc_attr__( 'Hoodies', 'dish' );
			$hoodies_description = esc_attr__( 'A short category description', 'dish' );

			$tshirts_name        = esc_attr__( 'Tshirts', 'dish' );
			$tshirts_description = esc_attr__( 'A short category description', 'dish' );

			$products = array(
				// Accessories.
				'beanie'             => array(
					'post_title'     => esc_attr__( 'Beanie', 'dish' ),
				...
				'belt'               => array(
					'post_title'     => esc_attr__( 'Belt', 'dish' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'cap'                => array(
					'post_title'     => esc_attr__( 'Cap', 'dish' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
					'thumbnail'      => '{{cap-image}}',
				...
				'sunglasses'         => array(
					'post_title'     => esc_attr__( 'Sunglasses', 'dish' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie-with-logo'   => array(
					'post_title'     => esc_attr__( 'Hoodie with Logo', 'dish' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie-with-pocket' => array(
					'post_title'     => esc_attr__( 'Hoodie with Pocket', 'dish' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie-with-zipper' => array(
					'post_title'     => esc_attr__( 'Hoodie with Zipper', 'dish' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie'             => array(
					'post_title'     => esc_attr__( 'Hoodie', 'dish' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'long-sleeve-tee'    => array(
					'post_title'     => esc_attr__( 'Long Sleeve Tee', 'dish' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'polo'               => array(
					'post_title'     => esc_attr__( 'Polo', 'dish' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'tshirt'             => array(
					'post_title'     => esc_attr__( 'Tshirt', 'dish' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'vneck-tee'          => array(
					'post_title'     => esc_attr__( 'Vneck Tshirt', 'dish' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
			...
			return apply_filters( 'dish_starter_content_products', $products );
		}
		...
		private function homepage_blocks_content() {
			$content = '
				...
				<h2 style="text-align:center">' . __( 'Shop by Category', 'dish' ) . '</h2>
				<!-- /wp:heading -->
				...
				<!-- wp:heading {"align":"center"} -->
				<h2 style="text-align:center">' . __( 'New In', 'dish' ) . '</h2>
				<!-- /wp:heading -->
				...
				<!-- wp:heading {"align":"center"} -->
				<h2 style="text-align:center">' . __( 'Fan Favorites', 'dish' ) . '</h2>
				<!-- /wp:heading -->

				<!-- wp:woocommerce/product-top-rated {"columns":4} /-->

				<!-- wp:heading {"align":"center"} -->
				<h2 style="text-align:center">' . __( 'On Sale', 'dish' ) . '</h2>
				<!-- /wp:heading -->

				<!-- wp:woocommerce/product-on-sale {"columns":4} /-->

				<!-- wp:heading {"align":"center"} -->
				<h2 style="text-align:center">' . __( 'Best Sellers', 'dish' ) . '</h2>
				<!-- /wp:heading -->
		...
		private function replace_homepage_blocks_symbols() {
			...
			if ( ! empty( $hero ) ) {
				$cover = '
					...
					<h1 style="text-align:center">' . __( 'Welcome', 'dish' ) . '</h1>
					<!-- /wp:heading -->

					<!-- wp:paragraph {"align":"center","customTextColor":"#000000"} -->
					<p style="color:#000000;text-align:center" class="has-text-color">' . __( 'This is your homepage which is what most visitors will see when they first visit your shop.', 'dish' ) . '</p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"align":"center","customTextColor":"#000000"} -->
					<p style="color:#000000;text-align:center" class="has-text-color">' . __( 'You can change this text by editing the "Welcome" page via the "Pages" menu in your dashboard.', 'dish' ) . '</p>
			...
			if ( ! empty( $products ) ) {
				$handpicked = '
					<!-- wp:heading {"align":"center"} -->
					<h2 style="text-align:center">' . __( 'We Recommend', 'dish' ) . '</h2>
					<!-- /wp:heading -->
		...
		private function validate_tasks( $tasks ) {
			$valid_tasks = apply_filters( 'dish_valid_tour_tasks', array( 'homepage', 'products' ) );
...
return new Dish_NUX_Starter_Content();
