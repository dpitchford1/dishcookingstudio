<?php
/**
 * Dish WooCommerce Adjacent Products Class
 *
 * @package  dish
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Dish_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Dish WooCommerce Adjacent Products Class
	 */
	class Dish_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'dish_woocommerce_adjacent_query_args', $args ) );
